...
const CustomerEdit: React.FC = () => {
  ...
  const [customer, setCustomer] = useState<Customer>({});//la variable Customer es el archivo Customer.ts 'interface'
            ...
            <IonRow>
              <IonCol>
                <IonItem>
                  ...
                  <IonInput onIonChange={e => customer.firstname = String(e.detail.value)}//obtener los que escribe en el input y lo asignamos
